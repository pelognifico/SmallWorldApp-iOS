//
//  DetailsMovieDisplayLogicMock.swift
//  SmallWorld-iOSTests
//
...
final class DetailsMovieDisplayLogicMock: DetailsMovieDisplayLogic {
    
    var viewModelDisplayDetailsMovie: HomeModel.MoviesList.ViewModel?
